...
export default async function AboutPage() {
  ...
  const openCount = branches.length;
  const cityChain = branches.map((l) => l.name).join(' to ');
  return (
    <>
        ...
        <div className="wrap">
          <div className="story__grid">
            <div className="story__copy" data-reveal>
              ...
              <p>Today FRYBIRD is the neighbourhood spot{cityChain ? <> from <strong>{cityChain}</strong></> : ''} — and the tray still says the same thing it always has.</p>
            </div>
      ...
      <section className="section story" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <div className="stats" data-reveal-stagger style={{ borderTop: 'none', paddingTop: 0 }}>
            <div className="stat"><div className="num"><span data-count={openCount}>0</span></div><div className="lbl">Locations &amp; Counting</div></div>
      ...
      <section className="timeline">
        <div className="wrap">
          ...
          <div className="tline" data-reveal-stagger>
            ...
            <div className="tstep"><div className="yr">03</div><h3>The Flock Grows</h3><p>From one branch to {countWord(openCount).toLowerCase()} across the Emirates and into Oman, each one bringing the same loud, crispy energy.</p></div>
